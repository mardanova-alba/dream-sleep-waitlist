          ...
          <div className="space-y-8">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className="flex-1 bg-gradient-to-br from-brand-light to-white rounded-2xl p-8 card-shadow hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-all duration-300">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                    <h3 className="text-xl md:text-2xl font-semibold text-brand-text">
                      {milestone.title}
                    </h3>
                    <span className="text-brand-accent font-semibold mt-2 sm:mt-0">
                      {milestone.quarter}
                    </span>
                  </div>
