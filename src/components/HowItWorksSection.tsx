      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="space-y-6 sm:space-y-8">
          {steps.map((step, index) => (
            <div 
              key={index} 
              className="flex flex-col md:flex-row items-start md:items-center gap-4 sm:gap-6 bg-white/30 backdrop-blur-md border-2 border-white/40 rounded-2xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-600 md:bg-white/30 hover:bg-white/35"
            >
