...
const HowItWorksSection = () => {
  ...
  return (
    <section className="py-32 px-6 bg-gradient-to-b from-white via-brand-light/30 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-brand-primary rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-1/4 left-1/6 w-1.5 h-1.5 bg-brand-accent rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 right-1/4 w-1 h-1 bg-brand-primary rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
        <div className="absolute bottom-1/3 right-1/6 w-2 h-2 bg-brand-accent rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
      </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="space-y-4 max-w-xs">
                  <h3 className="text-lg md:text-xl font-semibold text-brand-text leading-tight">
                    {step.title}
                  </h3>
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-16 -right-2 text-brand-accent/50 text-xl transform -translate-y-1/2">
                    →
                  </div>
                )}
              </div>
