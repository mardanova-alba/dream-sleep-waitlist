  ...
  return <section className="py-24 px-6 bg-gradient-to-bl from-brand-dark to-brand-light bg-brand-accent\n">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {problems.map((problem, index) => <div key={index} className="border border-gray-50 rounded-2xl p-8 shadow-md hover:shadow-[0_8px_24px_rgba(0,0,0,0.20)] transition-all duration-300 hover:-translate-y-1\\\\n bg-neutral-50">
