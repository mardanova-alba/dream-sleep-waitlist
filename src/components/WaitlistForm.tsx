        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <Button
              ...
              onClick={onClose}
              variant="outline"
              className="flex-1 pill-button border-brand-accent/30 text-brand-text hover:bg-brand-light"
            >
              Cancel
            </Button>
            <Button
              ...
              className="flex-1 pill-button bg-brand-accent text-brand-text hover:bg-brand-accent/90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
